...
For the complete upstream guide with all rules expanded, see
[`R3F_BEST_PRACTICES.md`](https://github.com/emalorenzo/three-agent-skills/blob/main/R3F_BEST_PRACTICES.md).
